...
const navLinks = [
  ...
  { label: 'iPhone',              href: '/tienda?categoria=iphone' },
  { label: 'DJI Estabilizadores', href: '/tienda?categoria=dji-estab' },
  { label: 'DJI Audio',           href: '/tienda?categoria=dji-audio' },
...
const social = [
  ...
  { Icon: TkIcon,  label: 'TikTok',    value: '@nexopro',         href: '#' },
]
