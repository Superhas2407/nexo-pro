const categories = [
  {
    ...
    icon: (
      <svg width="30" height="54" viewBox="0 0 30 54" fill="none">
        ...
        <rect x="8" y="7" width="14" height="4" rx="2" fill="#0057FF" opacity="0.5"/>
  ...
  },
  {
    ...
    icon: (
      <svg width="38" height="54" viewBox="0 0 38 54" fill="none">
        <rect x="16" y="2" width="6" height="20" rx="3" fill="rgba(14,167,183,0.2)" stroke="#0057FF" strokeWidth="1.5"/>
        <circle cx="19" cy="9" r="7" stroke="#075356" strokeWidth="1.5" fill="rgba(7,83,86,0.06)"/>
        <rect x="2" y="22" width="34" height="6" rx="3" fill="rgba(14,167,183,0.15)" stroke="#0057FF" strokeWidth="1.5"/>
        ...
        <rect x="16" y="28" width="6" height="22" rx="3" fill="rgba(14,167,183,0.15)" stroke="#0057FF" strokeWidth="1.5"/>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="28" height="50" viewBox="0 0 28 50" fill="none">
        <rect x="7" y="2" width="14" height="26" rx="7" stroke="#0057FF" strokeWidth="1.5" fill="rgba(14,167,183,0.08)"/>
  ...
  },
  {
    ...
    icon: (
      <svg width="62" height="28" viewBox="0 0 62 28" fill="none">
        <rect x="2" y="5" width="24" height="18" rx="5" stroke="#0057FF" strokeWidth="1.5" fill="rgba(14,167,183,0.08)"/>
        <rect x="36" y="5" width="24" height="18" rx="5" stroke="#0057FF" strokeWidth="1.5" fill="rgba(14,167,183,0.08)"/>
